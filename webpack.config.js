...
module.exports = {
    ...
    module: {
        rules: [
            ...
            },
            {
                ...
                use: [
                    {
                        loader: 'file-loader?name=./font/Code-Pro/[name].[ext]'
                    },
                    {
                        loader: 'file-loader?name=./font/helveticaneuecyr/[name].[ext]'
                    }
                ]
            },
            {
  ...
  plugins: [
    new HtmlWebpackPlugin({
      ...
      new HtmlWebpackPlugin({
          template: __dirname + '/src/pug/form.pug',
      ...
      new HtmlWebpackPlugin({
          template: __dirname + '/src/pug/basket.pug',
          filename: __dirname + '/dist/basket.html'
      }),
      new HtmlWebpackPlugin({
